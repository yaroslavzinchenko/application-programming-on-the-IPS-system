...
int main()
{
	...
	cout << "С параллелизацией на 4-х потоках с автоматическим параллелизатором: " << endl;
	t1 = chrono::high_resolution_clock::now();

	n = 100;
	h = (b - a) / n;

	cout << "Метод левых прямоугольников с параллелизацией на 4-х потоках с автоматическим параллелизатором:" << endl;
	...
	cout << "Время подсчёта методом левых прямоугольников с параллелизацией на 4-х потоках с автоматическим параллелизатором: " << durationLeftRectanglesQPar.count() << " секунд." << endl << endl;
